...
void drawIcon(CardPosition card, int iconId, double radius, double angle,
              double rotation, double scale, int *centerX, int *centerY) {
  int cardCenterX, cardCenterY;
  ...
  SDL_RenderCopyEx(g.renderer, g.iconTexture, &tmpRect, &dstRect, rotation,
                   NULL, SDL_FLIP_NONE);
}
